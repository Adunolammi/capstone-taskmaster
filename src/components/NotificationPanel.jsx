...
import { useMarkNotiAsReadMutation, useGetNotificationsQuery } from "../redux/slices/api/userApiSlice.js";
...
const ICONS = {
  alert: (
    <HiBellAlert className='h-5 w-5 text-gray-600 group-hover:text-teal-600' />
  ),
  message: (
    <BiSolidMessageRounded className='h-5 w-5 text-gray-600 group-hover:text-teal-600' />
  ),
};
